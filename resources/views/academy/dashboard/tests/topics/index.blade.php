...
<div class="container page__container page-section">
    ...
    <div class="page-separator">
        <div class="page-separator__text">{{ $test->name }}</div>
    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            class="sort"
                                            data-sort="js-lists-values-employee-name">العنوان </a>
                                        </th>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-flex flex-column">
                                                    <p class="mb-0"><strong class="js-lists-values-employee-name"><a href="{{ route('questions.index', $topic->id) }}">{{ $topic->name }}</strong></p>
                                            ...
                                            <td class="js-lists-values-earnings small">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="{{ route('question.create', $topic->id) }}" class="dropdown-item text-secondary">إضافة سؤال</button>
