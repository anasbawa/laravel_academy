...
<div class="container page__container page-section">
    ...
    <form method="POST" action="{{ route('paths.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row mb-32pt">
            <div class="col-lg-4">
                <div class="page-separator">
                    <div class="page-separator__text">إضافة مسار أكاديمي </div>
                </div>
            </div>
                ...
                <div class="flex"
                    ...
                    <div class="form-group">
                        <label class="form-label"
                            for="exampleInputEmail1">اسم المسار</label>
                        <input type="text"
                                name="name"
                            class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <select id="custom-select"
                                ...
                                <option selected>قائمة التخصصات</option>
