                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item"
                                   href="{{ route('profile.edit') }}">تعديل الحساب</a>
                                <a class="dropdown-item"
                                   href="login.html" onclick="event.preventDefault(); document.getElementById('logoutform').submit();" >Logout</a>
                                    <form method="POST" action="{{ route('academy.logout') }}" id="logoutform">
                                        @csrf
                                    </form>
                            </div>
                        </div>
