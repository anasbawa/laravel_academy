...
<div class="mdk-header-layout js-mdk-header-layout">
    <div class="container page__container page-section">
        <div class="page-separator">
            <div class="page-separator__text">الأكاديميات</div>
        </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px;">
                                <a href="javascript:void(0)"
                                   class="sort"
                                   data-sort="js-lists-values-department">تاريخ الانضمام</a>
                            </th>
                            ...
                            <td>
                                ...
                                <div class="media flex-nowrap align-items-center"
                                     ...
                                     <div class="avatar avatar-sm mr-8pt">
                                        ...
                                        <img src="{{ URL::asset('images/academies'). '/' .$academy->photo }}"
                                             alt="{{ $academy->name }}"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex d-flex flex-column">
                                                <p class="mb-0"><strong class="js-lists-values-name">{{ $academy->name }}</strong></p>
                                                <small class="js-lists-values-email text-50">{{ $academy->email }}</small>
                                            </div>
                            ...
                            <td>
                                ...
                                <div class="media-body">
                                    <div class="d-flex flex-column">
                                        <small class="js-lists-values-department"><strong>{{ $academy->created_at->diffForHumans() }}</strong></small>
                            ...
                            <td class="text-right">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <form action="/student/academy/{{ $academy->id }}" method="POST" id="delete">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
